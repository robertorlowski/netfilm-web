...
function default_1(req, res, db) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sortBy = req.query.category == undefined ? "popularity" : req.query.sortBy;
        var genres = req.query.genres == undefined
            ? []
            : req.query.genres
                .toString()
                .split(",")
...
//# sourceMappingURL=fetchMoviesForGenres.js.map